...
interface IExchange {
    function ethToTokenSwap(uint256 _miniTokens) external payable;

    function ethToTokenTransfer(uint256 _miniTokens, address _recipent)
        external
        payable;
}
